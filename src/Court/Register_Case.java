...
public class Register_Case extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("NEW CASE REGISTRASTION");
        jLabel10.setName("jLabel10"); // NOI18N

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "New Case Registration", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(date_committed, javax.swing.GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (case_no.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "Please enter details");
        }else if (date_committed.getDate().after(date_Reported.getDate())) {
             JOptionPane.showMessageDialog(this, "Please Youn can not report before committing",
                    "Error", JOptionPane.ERROR_MESSAGE);
        }else if (date_committed.getDate().after(today.getTime())||date_Reported.getDate().after(today.getTime())) {
             JOptionPane.showMessageDialog(this, "Please No Future Dates",
                    "Error", JOptionPane.ERROR_MESSAGE);
        }  else {
            try {
                String date1 = ((JTextField) date_committed.getDateEditor().getUiComponent()).getText();
                String date2 = ((JTextField) date_Reported.getDateEditor().getUiComponent()).getText();

                String sql = "INSERT INTO cases (case_no,Offence,date_committed,date_reported,narration) VALUES(?,?,?,?,?)";
                pst = conn.prepareStatement(sql);
                pst.setString(1, case_no.getText());
                pst.setString(2, txt_offence.getText());
                pst.setString(3, date1);
                pst.setString(4, date2);
                pst.setString(5, jTextArea1.getText());
                pst.execute();
                
                String sql2 = "INSERT INTO complainants (National_Id,case_no,FullName,Age,Gender,Address) VALUES(?,?,?,?,?,?)";
                pst = conn.prepareStatement(sql2);
                pst.setString(1, txt_regno1.getText());
                pst.setString(2, case_no.getText());
                pst.setString(3, txt_fullname1.getText());
                pst.setString(4, txt_course1.getText());
                pst.setString(5, jComboBox1.getSelectedItem().toString());
                pst.setString(6, jTextArea1.getText());
                pst.execute();
                
                 String sql3 = "INSERT INTO respondents (National_Id,case_no,FullName,Age,Gender,Address) VALUES(?,?,?,?,?,?)";
                pst = conn.prepareStatement(sql3);
                pst.setString(1, txt_regno2.getText());
                pst.setString(2, case_no.getText());
                pst.setString(3, txt_fullname2.getText());
                pst.setString(4, txt_course2.getText());
                ...
                Logger.getLogger(Register_Case.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public com.toedter.calendar.JDateChooser date_Reported;
    public com.toedter.calendar.JDateChooser date_committed;
